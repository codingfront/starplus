(function () {
  ...
  function k(a, b) {
    b &&
      (!0 === b && (b = "yes"), C("meta", { name: a, content: b }, '[name="' + a + '"]'));
  }
  function R(a) {
  ...
  function G(a, b) {
      ...
      if (c.width < 0.8 * f) l.fillText(e, c.width / -2, 0);
        ...
        for (e = e.split(/\s+/g), c = 1; c <= e.length; ++c) {
          ...
          if (c === e.length || I > 0.6 * f)
            l.fillText(H, I / -2, 0), l.translate(0, 1.2 * m), e.splice(0, c), (c = 0);
        }
      return function () {
    ...
    var z = (0 < p.length ? p : q)
      .map(function (f) {
        ...
        if (A && !(120 > f.h))
          return (
            (c.rel = "apple-touch-icon"), C("link", c, '[rel="apple-touch-icon"]' + h)
          );
      })
      .filter(Boolean);
    ...
    if (A) {
      ...
      (q =
        { por: "portrait", lan: "landscape" }[String(a.orientation || "").substr(0, 3)] ||
        ""),
        k("x5-orientation", q),
